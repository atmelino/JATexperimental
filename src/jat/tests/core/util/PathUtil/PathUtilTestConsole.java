...
public class PathUtilTestConsole extends JApplet {

	private static final long serialVersionUID = -5288937301478318959L;

	public void init() {

		//System.out.println("PathUtilTestConsole init");
		...
		System.out.println("Loading file /data/tests/core/util/PathUtil/inputFile.txt");
