...
abstract public class SphericalHarmonicGravity implements EarthForceModel, ForceModel {
    ...
    /** Initialize the value of GM.
     * @param gm the planetary gravity constant.
     */
    protected void initializeGM(double gm){
        this.GM = gm;
    }

    /** Initialize the R_ref.
     * @param rref the planetary R_ref value.
     */
    protected void initializeR_ref(double rref){
        this.R_ref = rref;
    }
...
//        a_bf.print("body fixed gravity");
    ...
    public VectorN acceleration(EarthRef eRef, Spacecraft sc){
    	return gravity(sc.r(),eRef.eci2ecef());
    }
    ...
    public Matrix gravityGradient(VectorN r, Matrix E){
        ...
        out = out.times(GM/(R_ref*R_ref*R_ref));
