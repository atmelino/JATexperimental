...
* @version 1.0
*/
public class GPS_MeasurementModel implements MeasurementModel {
	...
	public GPS_MeasurementModel(RGPS_MeasurementList gps, GPS_Constellation con){
		this.gpsData = gps;
		this.constell = con;
		this.nsv = con.size();
		this.numberOfStates = 10 + this.nsv;
