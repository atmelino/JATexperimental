...
* @version 1.0
*/
public class GPS_MP_MeasurementGenerator {
	 ...
	 * @param v1 Visible checker
	 * @param v2 Visible checker
	 ...
	 */
	public GPS_MP_MeasurementGenerator(
		Trajectory t,
		Trajectory i,
		GPS_Constellation c,
		Visible v1,
...
//		String msfile = "rgpsmeas_vbar.txt";
		...
		GPS_MP_MeasurementGenerator x = new GPS_MP_MeasurementGenerator(truetraj,isstraj, constellation, block, mask, outfile, clp, mlp, seed);
		x.generate();
