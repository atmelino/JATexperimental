...
/**
* The RGPS_MP_MeasurementGenerator.java Class generates relative GPS measurements
* including the effects of multipath.
* @author 
* @version 1.0
*/
public class RGPS_MP_MeasurementGenerator {
	 ...
	 */
	public RGPS_MP_MeasurementGenerator(
		Trajectory t,
		Trajectory i,
		GPS_Constellation c,
		Visible v1,
...
//		String msfile = "rgpsmeas_vbar.txt";
		...
		RGPS_MP_MeasurementGenerator x = new RGPS_MP_MeasurementGenerator(truetraj,isstraj, constellation, block, mask, outfile, clp, mlp, seed);
		x.generate();
