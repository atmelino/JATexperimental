...
//		double vz1 = y[11];
		...
		double nn0 = -1.0 * (mu  / rcubed0) * (1.0 - 1.5 * re_r0 * j2 * (zsq_rsq0 - 2.0));
		...
		out[3] = -mu*xx0/(dcubed0);
		out[4] = -mu*yy0/(dcubed0);
		out[5] = -mu*zz0/(dcubed0);
		...
		System.out.println("X Y Z " + dldx0 + " " + dmdy0 + " " + dndz0 );
