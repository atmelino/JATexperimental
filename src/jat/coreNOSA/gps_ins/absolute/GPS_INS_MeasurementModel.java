...
package jat.coreNOSA.gps_ins.absolute;
...
* @version 1.0
*/
public class GPS_INS_MeasurementModel implements MeasurementModel {
	...
	private static final int clockIndexA = 16;
	
	private boolean[] firstTime;

	/**
	 * Constructor
	 * @param gps RGPS_MeasurementList
	 * @param con GPS_Constellation
	 */	
	public GPS_INS_MeasurementModel(RGPS_MeasurementList gps, GPS_Constellation con){
		this.gpsData = gps;
		this.constell = con;
		this.nsv = con.size();
		this.numberOfStates = 19 + this.nsv;
	...
	/**
	 * @see jat.coreNOSA.algorithm.estimators.MeasurementModel#H(VectorN)
	 */
	...
	/**
	 * @see jat.coreNOSA.algorithm.estimators.MeasurementModel#R()
	 */
	public double R() {
	...
	/**
	 * @see jat.coreNOSA.algorithm.estimators.MeasurementModel#zPred(int, double, VectorN)
	 */
...
//
//		// extract the current spacecraft position vector		
//		VectorN r = xref.get(this.stateIndexA, 3);
//		VectorN v = xref.get((this.stateIndexA+3), 3);
...
//
//		htilde.set(this.stateIndexA, drhodr1);
//		htilde.set(this.stateIndexB, drhodr2);
//		
//		VectorN drhodv1 = drrdv1.times(term1);
//		VectorN drhodv2 = drrdv2.times(term2);
//		drhodv2 = drhodv2.times(-1.0);
//		htilde.set((this.stateIndexA+3), drhodv1);
...
//		
//		htilde.set(this.clockIndexA, drdbc1); 
