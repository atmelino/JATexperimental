...
* @version 1.0
*/
public class RGPS_SIGI_ProcessModel implements Derivs, ProcessModel {
...
//	private INS_Measurement insMeas;
	 ...
	 */
	public RGPS_SIGI_ProcessModel(INS_MeasurementList ins, GPS_Constellation gps, LinePrinter l1, LinePrinter l2, LinePrinter l3) {
		this.insData = ins;
		this.gpscon = gps;
		this.nsv = gps.size();
