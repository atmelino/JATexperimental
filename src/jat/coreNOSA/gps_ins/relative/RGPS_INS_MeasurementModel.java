...
* the RGPS/INS extended Kalman filters.
* @author 
* @version 1.0
*/
public class RGPS_INS_MeasurementModel implements MeasurementModel {
	 ...
	 */		
	public RGPS_INS_MeasurementModel(RGPS_MeasurementList gps, GPS_Constellation con){
		this.gpsData = gps;
		this.constell = con;
		this.nsv = con.size();
		this.numberOfStates = 28 + 2 * this.nsv;
		this.stateIndexB = this.nsv + 19;
		this.clockIndexB = this.stateIndexB + 6;
		this.iaIndex = this.nsv + 28;
