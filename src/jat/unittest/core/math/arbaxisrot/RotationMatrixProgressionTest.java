...
import jat.core.math.arbaxisrot.RotationMatrix;
import jat.core.math.arbaxisrot.RotationMatrix2005;
...
public class RotationMatrixProgressionTest extends TestCase {
    ...
    public static Test suite() {
        ...
        return new TestSuite(RotationMatrixProgressionTest.class);
    }
    ...
    /**
     * Test that newer {@link AbstractRotationMatrix} instances give the same
    ...
    public void testRotationMatrixProgression() {
        ...
        while (numTrials > 0) {
            ...
            RotationMatrixFull rMFull 
                = new RotationMatrixFull(a, b, c, u, v, w, angle);
