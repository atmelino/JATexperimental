 ...
 */
package jat.unittest.core.math.arbaxisrot;

import jat.core.math.arbaxisrot.AbstractRotationMatrix;
...
/**
 * <p>A class to test the RotationMatrixFull class. Run with: </p>
 *
 * <pre>
 * java -cp classes:lib/junit_3.8.1-mac.jar junit.swingui.TestRunner    \
 *                     arbaxisrot.RotationMatrixFullTest
 * </pre>
 *
 * @author Glenn Murray
 */
public class RotationMatrixFullTest extends TestCase {
    ...
    private static final double TOLERANCE = AbstractRotationMatrix.TOLERANCE;


    // Instance Variables-----------------------------------------------

    private double pi = Math.PI;
    /** See {@link RotationMatrixFull}. */
    private double a = 0;
    private double b = 0;
    private double c = 0;
    private double u = 1;
     ...
     * For JUnit.
     */
    public RotationMatrixFullTest(String name) {
        super(name);
    }
  ...
  //      return new TestSuite(arbaxisrot.RotationMatrixFullTest.class);
        return new TestSuite(RotationMatrixFullTest.class);
    }
    ...
    public void testRotationMatrixFull() {
        u = 2;
        RotationMatrixFull rM = new RotationMatrixFull(a, b, c, u, v, w, theta);
    ...
    public void testRotPointFromFormula() {
        ...
        for(int j=0; j<20; j++) {
            ...
            RotationMatrixFull rMInit 
                = new RotationMatrixFull(a, b, c, u, v, w, theta);
            // Build the uninitialized matrix.
            RotationMatrixFull rM = new RotationMatrixFull();
            if(LOG) rM.logMatrix();
